...
exports.CommentDetailPanel = void 0;
const vscode = require("vscode");
class CommentDetailPanel {
    static createOrShow(extensionUri, comment, commentManager) {
        ...
        // 否则创建新面板
        const panel = vscode.window.createWebviewPanel(CommentDetailPanel.viewType, '评审意见详情', column || vscode.ViewColumn.One, {
            enableScripts: true,
    ...
    constructor(panel, extensionUri, comment, commentManager) {
        this._disposables = [];
        this._panel = panel;
...
Git分支: ${comment.gitBranchName || '无'}\`;
    ...
    _handleEditConfirm() {
        ...
        EditConfirmPanel.createOrShow(this._extensionUri, this._comment, async (updatedComment) => {
...
exports.CommentDetailPanel = CommentDetailPanel;
CommentDetailPanel.viewType = 'commentDetailPanel';
//# sourceMappingURL=CommentDetailPanel.js.map