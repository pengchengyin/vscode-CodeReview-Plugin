...
export class CodeReviewProvider implements vscode.TreeDataProvider<ReviewCommentItem> {
    private _onDidChangeTreeData: vscode.EventEmitter<ReviewCommentItem | undefined | null | void> = new vscode.EventEmitter<ReviewCommentItem | undefined | null | void>();
    readonly onDidChangeTreeData: vscode.Event<ReviewCommentItem | undefined | null | void> = this._onDidChangeTreeData.event;

    constructor(private commentManager: ReviewCommentManager) {}
    ...
    getTreeItem(element: ReviewCommentItem): vscode.TreeItem {
        return element;
    }

    getChildren(element?: ReviewCommentItem): Thenable<ReviewCommentItem[]> {
...
export class ReviewCommentItem extends vscode.TreeItem {
    constructor(
        ...
        private readonly commentManager: ReviewCommentManager
    ) {
    ...
    private getTooltip(): string {
        ...
        const typeText = typeMap[this.comment.type as keyof typeof typeMap] || this.comment.type;
        ...
        const projectName = projectMap[this.comment.projectId as keyof typeof projectMap] || this.comment.projectId || '无';
...
项目信息: ${projectName}`;
    ...
    private getDescription(): string {
        ...
        const confirmStatus = confirmResultMap[this.comment.confirmResult as keyof typeof confirmResultMap] || '未确认';
