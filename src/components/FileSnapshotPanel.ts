...
export class FileSnapshotPanel {
    public static currentPanel: FileSnapshotPanel | undefined;
    public static readonly viewType = 'fileSnapshotPanel';
    private readonly _panel: vscode.WebviewPanel;
    private readonly _extensionUri: vscode.Uri;
    private _disposables: vscode.Disposable[] = [];

    public static createOrShow(extensionUri: vscode.Uri, comment: ReviewComment) {
    ...
    private constructor(panel: vscode.WebviewPanel, extensionUri: vscode.Uri, comment?: ReviewComment) {
        this._panel = panel;
...
<body>
    ...
    private _formatCodeContent(text: string): string {
        if (!text) return '';
    ...
    private async _saveSnapshotToFile(content: string, fileName: string) {
        try {
